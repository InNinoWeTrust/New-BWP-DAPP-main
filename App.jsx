...
const App = () => {
  ...
  const { contract: token } = useContract(
    '0x429b958f74810902d90Ad85c5Ff200fefFCFDB08',
    'token',
  );
  const { contract: vote } = useContract(
    '0x19733aC20CEd46593E29Ac27230069A2F8df6A3b',
    'vote',
  );
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Welcome to<h1> </h1> 🫗Brown Waters DAO</h1>
    ...
    <div className="mint-nft">
      ...
      <div className="btn-hero">
        <Web3Button
          ...
          onSuccess={() => {
            console.log(
              `🌊 Successfully Minted! Check it out on OpenSea: https://opensea.io/collection/brownwaters`,
            );
          }}
          onError={(error) => {
